  ...
  describe("backtested", function() {
    ...
    describe("createFrom", function() {
      it("should work", function() {
        expect(vec3.createFrom(1, 2, 3)).toBeEqualish([1,2,3]);
      });
    });

    describe("equal", function() {
      it("should work", function() {
        expect(vec3.equal([1,2,3], [1,2,3])).toBeTruthy();
        expect(vec3.equal([1,2,3], [1,2,4])).toBeFalsy();
      });
    });
    ...
    describe("multiply", function() {
      ...
      it("should work", function() {
        expect(vec3.multiply(a, b, out)).toBeEqualish([1,4,9]);
      });

      it("should return dest", function() {
        expect(vec3.multiply(a, b, out)).toBe(out);
      });

      it("should store in a", function() {
        vec3.multiply(a, b);
        expect(a).toBeEqualish([1,4,9]);
      });
    });

    describe("squaredLength", function() {
      it("should work", function() {
        expect(vec3.squaredLength([1,2,3])).toBeEqualish(14);
      });
    });

    describe("distance", function() {
      it("should work", function() {
        expect(vec3.dist([1,2,3], [3,2,1])).toBeEqualish(Math.sqrt(8));
      });
    });
  });
