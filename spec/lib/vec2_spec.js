  ...
  describe("backtested", function() {
    ...
    describe("createFrom", function() {
      it("should work", function() {
        expect(vec2.createFrom(1,2)).toBeEqualish([1,2]);
      });
    });

    describe("equal", function() {
      it("should work", function() {
        expect(vec2.equal([1,2], [1,2])).toBeTruthy();
        expect(vec2.equal([1,2], [1,3])).toBeFalsy();
      });
    });

    describe("squaredLength", function() {
      it("should work", function() {
        expect(vec2.squaredLength([1,2])).toBeEqualish(5);
      });
    });
  });
