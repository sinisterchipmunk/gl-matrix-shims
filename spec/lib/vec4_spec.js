  ...
  describe("backtested", function() {
    ...
    describe("createFrom", function() {
      it("should work", function() {
        expect(vec4.createFrom(1, 2, 3, 4)).toBeEqualish([1,2,3,4]);
      });
    });

    describe("equal", function() {
      it("should work", function() {
        expect(vec4.equal([1,2,3,4], [1,2,3,4])).toBeTruthy();
        expect(vec4.equal([1,2,3,4], [1,2,4,4])).toBeFalsy();
      });
    });

    describe("length", function() {
      it("should work", function() {
        expect(vec4.length([1,2,3,4])).toBeEqualish(5.477225575051661);
      });
    });

    describe("squaredLength", function() {
      it("should work", function() {
        expect(vec4.squaredLength([1,2,3,4])).toBeEqualish(30);
      });
    });
  });
