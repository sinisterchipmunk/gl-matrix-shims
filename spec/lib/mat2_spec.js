describe("mat2", function() {
  ...
  describe("backtested", function() {
    ...
    describe("createFrom", function() {
      it("should work", function() {
        expect(mat2.createFrom(1,2,3,4)).toBeEqualish([1,2,3,4]);
      });
    });

    describe("equal", function() {
      it("should work", function() {
        expect(mat2.equal([1,2,3,4], [1,2,3,4])).toBeTruthy();
        expect(mat2.equal([1,2,3,4], [1,3,3,4])).toBeFalsy();
      });
    });
  ...
  describe("create", function() {
    ...
    describe("with no src", function() {
      it("should set to identity", function() { expect(mat2.create()).toBeEqualish([0, 0, 0, 0]); });
    });
  });
  ...
  describe("multiplyVec2", function() {
    ...
    describe("with dest", function() {
      ...
      it("should set dest", function() { expect(dest).toBeEqualish([23, 34]); });
      it("should return dest", function() { expect(result).toBe(dest); });
      it("should not modify a", function() { expect(a).toBeEqualish([1, 2, 3, 4]); });
    ...
    describe("without dest", function() {
      ...
      it("should not change a", function() { expect(a).toBeEqualish([1, 2, 3, 4]); });
      it("should change b", function() { expect(b).toBeEqualish([23, 34]); });
